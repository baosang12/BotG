...
namespace BotG.Runtime {
  public sealed class RiskHeartbeatService {
    ...
    public RiskHeartbeatService(Robot robot, Telemetry.RiskSnapshotPersister persister, Telemetry.PositionSnapshotPersister? positionPersister = null, int seconds=15) 
        : this(robot, persister, positionPersister, seconds, TelemetryConfig.Load()) { }

    public RiskHeartbeatService(Robot robot, Telemetry.RiskSnapshotPersister persister, Telemetry.PositionSnapshotPersister? positionPersister, int seconds, TelemetryConfig config) {
      _robot = robot; 
